 ...
 */
@Slf4j
public class MultiNameDataListener extends AnalysisEventListener<MultiNameData> {
    ...
    private List<MultiNameData> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);

    @Override
    public void invoke(MultiNameData data, AnalysisContext context) {
