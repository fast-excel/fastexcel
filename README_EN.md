...
<p align="center">
    <a href="https://img.shields.io/github/actions/workflow/status/fast-excel/fastexcel/deploy-docs.yml"><img alt="GitHub Actions Workflow Status" src="https://img.shields.io/github/actions/workflow/status/fast-excel/fastexcel/deploy-docs.yml?style=flat-square&logo=deploy-docs.yml&logo=book&label=document"></a>
